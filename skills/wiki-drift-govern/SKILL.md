...
5. Read the affected page-family guidance and writing blocks before editing stable wiki content. Use `canonical-index.md` for index updates, and the relevant block guidance for activity maps, model relations, public surfaces, page navigation, dependency maps, decisions, sequences, or state transitions.
